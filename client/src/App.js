    ...
    return (
      <Router history={browserHistory}>
        ...
        <Switch>
          ...
          <Route exact path="/auth/login" component={OnlyNotAuthorizedUserHoc(LoginPage)} />
          <Route exact path="/auth/registration" component={OnlyNotAuthorizedUserHoc(RegistrationPage)} />
